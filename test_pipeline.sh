#!/usr/bin/env bash
# test_pipeline.sh — CI entrypoint for PulseQuant Phase 2 validation
# Usage:
...
.venv/bin/python -m pytest test/test_replay_engine.py -v --tb=short
...
if [[ "${RUN_INTEGRATION:-0}" == "1" ]]; then
    ...
    .venv/bin/python tools/fetch_vision_data.py \
